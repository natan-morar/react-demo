...
function FormField(props: { element: Frontier.Element; value?: any }) {
    ...
    const genInput = () => {
        switch (props.element.type) {
            ...
            case 'text':
                return <input type="text" className={inputClass} onChange={onChange} value={value}></input>;

            case 'textarea':
                return <input type="textarea" className={inputClass} onChange={onChange} value={value}></input>;
